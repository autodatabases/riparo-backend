      ...
      if (user_data) {
        ...
        if (!accountActive)
          return fun.returnResponse(
            ...
            false,
            401,
            "Your account is temporarily inactive. Please contact support team"
          );
  ...
  socialLogIn: async function (req, res) {
    try {
      ...
      req
        ...
        .notEmpty()
        .withMessage("Please enter profile picture");
      req
        .check("mergeAccount")
        .notEmpty()
        .withMessage("Please enter merge account");
      req
        .check("accountType")
        .notEmpty()
  ...
  changePassword: async function (req, res) {
    try {
      ...
      req
        ...
        .notEmpty()
        .withMessage("Please re-enter new password");
      var error = req.validationErrors();
      if (error) {
        return fun.returnResponse(
          res,
      ...
      const password = crypto
        .createHash("sha1")
        .update(requestData.currentPassword)
        .digest("hex");
      ...
      if (user_data) {
        const newPassword = crypto
          .createHash("sha1")
          .update(requestData.newPassword)
          .digest("hex");
...
|------------------------------------------------------------------------ */
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Category id with " + req.params.id + " not found."
        );
      ...
      if (!checkMembershipOption) {
        updateData = await RiparoFriendsCategories.update(
          { title: requestData.title },
          {
            where: {
              id: req.params.id,
        ...
        return fun.returnResponse(
          ...
          false,
          400,
          "Category already added with same title."
        );
        return false;
      }
    } catch (error) {
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Membership id with " + req.params.id + " not found."
        );
  ...
  allRfCategories: async function (req, res) {
    try {
      ...
      allOptions = await RiparoFriendsCategories.findAndCountAll({
        where: whereCond,
      });
  ...
  changeRowStatus: async function (req, res) {
    try {
      ...
      if (requestData.table == "membership_options") {
        ...
        requestData.table == "paymentMethods_Stripe" ||
        requestData.table == "paymentMethods_Paypal"
      ) {
      ...
      if (!idValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Resource id " + req.params.id + " not found."
        );

      if (requestData.table == "membership_options") {
        updateData = await MembershipOption.update(
        ...
        updateData = await FreightZones.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await TaArticleRecommends.update(
          { isFeatured: requestData.value },
          {
            where: {
              id: req.params.id,
            },
        ...
        updateData = await TaArticleRecommends.update(
          { isRecommended: requestData.value },
          {
            where: {
              id: req.params.id,
            },
        ...
        updateData = await RuntRegisteredVehicles.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await Sliders.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await PaymentMethods.update(
          { isStripeEnabled: requestData.value },
          {
            where: {
              id: req.params.id,
            },
        ...
        updateData = await PaymentMethods.update(
          { isPaypalEnabled: requestData.value },
          {
            where: {
              id: req.params.id,
            },
        ...
        updateData = await TaGetAmBrands.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await TaGetModelSeries.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await TaGetVehicleIdsByCriteria.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await FaqsCategories.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await SupplierArticles.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await Currencies.update(
          { status: requestData.value },
          {
            where: {
              id: req.params.id,
        ...
        updateData = await User.update(
          { accountStatus: requestData.value },
          {
            where: {
              id: req.params.id,
            },
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Customer id with " + req.query.id + " not found."
        );
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Supplier id with " + req.query.id + " not found."
        );
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "ArticleQas id with " + req.params.id + " not found."
        );
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Question id with " + req.params.id + " not found."
        );

      updateData = await ArticleQas.update(
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Zone id with " + req.params.id + " not found."
        );
      ...
      if (!checkMembershipOption) {
        updateData = await FreightZones.update(
          { name: requestData.name, code: requestData.code },
          {
            where: {
              id: req.params.id,
            },
        ...
        return fun.returnResponse(
          ...
          false,
          400,
          "Zone already added with same name."
        );
        return false;
      }
    } catch (error) {
  ...
  importZonePricing: async function (req, res) {
    try {
      ...
      readXlsxFile(
        fs.createReadStream(process.cwd() + "/server/public/" + oldpath)
      ).then(async (rows) => {
        rows = rows.slice(1);
  ...
  allZonePricing: async function (req, res) {
    try {
      ...
      allData = await FreightPricingWeight.findAndCountAll({
        where: whereCond,
      });
      const totalPages = Math.ceil(allData.count / limit);
    ...
    try {
      ...
      if (!optionIsValid)
        return fun.returnResponse(
          ...
          false,
          404,
          "articleNumber with number " + req.query.articleNumber + " not found."
        );
      ...
      if (membershipOption) {
        ...
        if (membershipOption.currency !== "COP") {
          ...
          membershipOption.price =
            Number(membershipOption.price) *
            Number(checkCurrencyValue.valueInCop);
        }
        ...
        if (pricingCatSub) {
          var indExp = (
            membershipOption.price *
            (pricingCatSub.indExp / 100)
          ).toFixed(4);
          var dCost = (
            membershipOption.price *
            (pricingCatSub.directCost / 100)
          ).toFixed(4);
          var tecPrcnt = (
            membershipOption.price *
            (pricingCatSub.tecPercent / 100)
          ).toFixed(4);

          membershipOption.retailPrice = parseInt(
            Number(membershipOption.price) +
              Number(vat) +
              Number(insuranceVal) +
              Number(indExp) +
          ...
          membershipOption.salePrice = parseInt(
            (Number(membershipOption.price) + Number(vat)) *
              (1 - pricingCatSub.discount / 100)
          )
            .toString()
            .replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.");
        } else {
  ...
  allZoneCountries: async function (req, res) {
    try {
      ...
      allData = await FreightZoneCountries.findAndCountAll({
        where: whereCond,
      });
      const totalPages = Math.ceil(allData.count / limit);
  ...
  addZoneCountries: async function (req, res) {
    try {
      req
        .check("zoneNumber")
        .notEmpty()
        .withMessage("Please enter zoneNumber.");
      req
        .check("englishName")
        .notEmpty()
        .withMessage("Please enter englishName.");
      req
        .check("spanishName")
        .notEmpty()
        .withMessage("Please enter spanishName.");
      var error = req.validationErrors();
      if (error) {
        return fun.returnResponse(
          res,
      ...
      if (!checkAlr) {
        ...
        return fun.returnResponse(
          ...
          false,
          409,
          "Already added with same country and zone."
        );
        return false;
      }
    } catch (error) {
    ...
    try {
      ...
      if (!IsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Country id with " + req.params.id + " not found."
        );
  ...
  addZonePricing: async function (req, res) {
    try {
      req
        .check("zoneNumberFrom")
        .notEmpty()
        .withMessage("Please origin zoneNumber.");
      req
        .check("zoneNumberTo")
        .notEmpty()
        .withMessage("Please destination zoneNumber.");
      req.check("weight").notEmpty().withMessage("Please enter weight.");
      req.check("price").notEmpty().withMessage("Please enter price.");
      req
        .check("localTaxes")
        .notEmpty()
        .withMessage("Please enter localTaxes.");
      req
        .check("expressDelivery")
        .notEmpty()
        .withMessage("Please enter expressDelivery.");
      var error = req.validationErrors();
      if (error) {
        return fun.returnResponse(
          res,
      ...
      if (!checkAlr) {
        ...
        return fun.returnResponse(
          ...
          false,
          409,
          "Already added with same weight and zone."
        );
        return false;
      }
    } catch (error) {
    ...
    try {
      ...
      if (!check) {
        ...
        return fun.returnResponse(
          ...
          false,
          400,
          "Already added with same zone and weight."
        );
        return false;
      }
    } catch (error) {
    ...
    try {
      ...
      if (!IsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Pricing id with " + req.params.id + " not found."
        );
  ...
  getZonePricingByShipment: async function (req, res) {
    try {
      ...
      allData = await FreightPricingWeight.sequelize.query(
        `SELECT * FROM freight_pricing_weight where zone_number_from = ` +
          req.query.zone1 +
          ` and zone_number_to = ` +
          req.query.zone2 +
          ` order by abs(weight - 2.7) limit 1`,
        {
      ...
      if (allData.length) {
        ...
        var shipmentPrice =
          Number(allData[0].price) +
          Number((allData[0].express_delivery / 100) * allData[0].price) +
          (Number(1) + Number(pricingCatSub.expectedProfit / 100)) +
          (Number(1) + Number(getVat.vat / 100));

        var expProfitt = parseInt(
          Number(shipmentPrice) * Number(pricingCatSub.expectedProfit / 100)
        );

        var expVatt = parseInt(
          Number(shipmentPrice) * Number(getVat.vat / 100)
        );

        data.finalShipmentPrice = parseInt(
          Number(shipmentPrice) + Number(expProfitt) + Number(expVatt)
        )
          .toString()
          .replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.");
      } else {
          ...
          if (getCd) {
            var customD = (
              (Number(req.query.price) +
                Number(req.query.price) * Number(getCd.fees / 100)) *
              Number(getVat.vat / 100)
            ).toFixed(4);
      ...
      if (getInsurancePricing.length) {
        for (var i = 0; i < getInsurancePricing.length; i++) {
          ...
          var testValue =
            Number(req.query.price) +
            Number(req.query.price) * Number(getInsurancePricing[i].rate / 100);

          if (getInsurancePricing[i].minimumValue > testValue) {
            // if minimum value is greater
          ...
          if (pricingCatSub2) {
            var expProfitt = parseInt(
              Number(newPrice) * Number(pricingCatSub2.expectedProfit / 100)
            );

            var expVatt = parseInt(
              Number(newPrice) * Number(getVat2.vat / 100)
            );

            getInsurancePricing[i].insuranceValue =
              Number(newPrice) + +Number(expProfitt) + Number(expVatt);
          }
        }
  ...
  allInsurancePricing: async function (req, res) {
    try {
      ...
      allData = await ShippingInsurancePrices.findAndCountAll({
        where: whereCond,
      });
      const totalPages = Math.ceil(allData.count / limit);
    ...
    try {
      ...
      if (!checkAlr) {
        ...
        return fun.returnResponse(
          ...
          false,
          409,
          "Already added with same shipment type and insurance."
        );
        return false;
      }
    } catch (error) {
  ...
  getArticlePriceByCatSubAll: async function (req, res) {
    try {
      ...
      if (req.query.search) {
        search =
          " and (  b.shortCutName LIKE '" +
          req.query.search +
          "%' OR c.assemblyGroupName LIKE '" +
          req.query.search +
          "%' OR d.brandName LIKE '" +
          req.query.search +
          "%') ";
      ...
      allData = await PricingByCatSub.sequelize.query(
        `SELECT a.*,b.shortCutName,c.assemblyGroupName,d.brandName from pricing_by_cat_sub as a , ta_parts_category as b , ta_parts_category_sub as c , ta_getambrands as d where a.category_id = b.shortCutId and a.sub_category_id = c.assemblyGroupNodeId and a.indirect_expense = d.brandId ` +
          search +
          ` order by a.id asc`,
        {
          type: sequelize.QueryTypes.SELECT,
      ...
      var allDataP = [];
      allDataP = await PricingByCatSub.sequelize.query(
        `SELECT a.*,b.shortCutName,c.assemblyGroupName,d.brandName from pricing_by_cat_sub as a , ta_parts_category as b , ta_parts_category_sub as c , ta_getambrands as d where a.category_id = b.shortCutId and a.sub_category_id = c.assemblyGroupNodeId and a.indirect_expense = d.brandId ` +
          search +
  ...
  getArticlePriceByCatSubOne: async function (req, res) {
    try {
      ...
      if (!optionIsValid) {
        ...
        allDataP = await PricingByCatSub.sequelize.query(
          `SELECT a.*,b.shortCutName,c.assemblyGroupName,d.brandName from pricing_by_cat_sub as a , ta_parts_category as b , ta_parts_category_sub as c , ta_getambrands as d where a.category_id = b.shortCutId and a.sub_category_id = c.assemblyGroupNodeId and a.indirect_expense = d.brandId and a.id = '` +
            req.params.id +
            `' `,
          {
            type: sequelize.QueryTypes.SELECT,
    ...
    try {
      ...
      if (!IsValid)
        return fun.returnResponse(
          ...
          false,
          401,
          "Resource id with " + req.params.id + " not found."
        );
    ...
    try {
      ...
      if (!fileData) {
        return fun.returnResponse(
          ...
          false,
          400,
          "Please select atleast one slider image"
        );
        return false;
      }
